...
SUFFIX=tar.gz
NAME=file
DOWNLOAD_URL=ftp://ftp.astron.com/pub/file//$NAME-$VVERSION.$SUFFIX
...
(cd $BUILD_DIR; CC=$CC CXX=$CXX CFLAGS="-std=c99 -fpie -fpic -fPIC" CPPFLAGS="-fpie -fpic -fPIC" LDFLAGS="-pie" ./configure --host $CONFIG_HOST --prefix /usr)
