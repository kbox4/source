#!/bin/bash
#https://github.com/kevinboone/solunar_cmdline/archive/0.1.3a.tar.gz

VERSION=0.1.3b
VVERSION=$VERSION
SUFFIX=tar.gz
NAME=solunar
DOWNLOAD_URL=https://github.com/kevinboone/solunar_cmdline/archive/$VVERSION.$SUFFIX

. ../../env.sh

BUILD_DIR=$STAGING/solunar_cmdline-${VERSION}
...
(cd $BUILD_DIR; make CC=$CC LDFLAGS="-pie" CFLAGS="-fpie -fpic"  DESTDIR=`pwd`/image all install)
