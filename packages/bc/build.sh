...
SUFFIX=tar.gz
NAME=bc
DOWNLOAD_URL=https://ftp.gnu.org/gnu/bc/$NAME-$VVERSION.$SUFFIX
...
(cd $BUILD_DIR; CC=$CC CXX=$CXX CFLAGS="-fpie -fpic" LDFLAGS="-pie" ./configure --host=$CONFIG_HOST --prefix=/usr --with-readline)
...
echo "Patching"
cp libmath.h $BUILD_DIR/bc/libmath.h
