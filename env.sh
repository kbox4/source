...
NDK=/home/kevin/lib/android-14-toolchain-arm/
...
SYSROOT=$NDK/sysroot/
ANDROID_PLATFORM_NAME=arm-linux-androideabi
ANDROID_PLATFORM_DIR=$NDK/platforms/android-16/arch-arm
CC_PREFIX=${NDK}/bin/arm-linux-androideabi-
...
STAGING=/home/kevin/lib/kbox4_staging/
...
CONFIG_HOST=arm
CONFIG_FULLHOST=arm-linux-androideabi
CONFIG_BUILD=i686
